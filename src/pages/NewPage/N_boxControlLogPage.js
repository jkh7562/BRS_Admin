                        ...
                        <div className="flex items-center border-b border-gray-200">
                            ...
                            <div className="flex">
                                <div className="relative">
                                    <select
                                        className="appearance-none px-6 py-3 font-medium text-base text-black focus:outline-none"
                                        value={logType}
                                        onChange={(e) => setLogType(e.target.value)}
                                    >
                                        <option value="discharge">배출로그</option>
                                        <option value="collection">수거로그</option>
                                    </select>
