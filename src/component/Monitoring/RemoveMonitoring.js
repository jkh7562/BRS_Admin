        ...
        <div className="flex h-[555px] bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div className="flex-1 relative flex flex-col">
                ...
                <div className="p-10 pb-9 bg-white">
                    <h2 className="text-2xl text-[#21262B] font-bold mb-1">[제거 진행중] 선문대학교 인문관 1층 수거함</h2>
                    <p className="text-[#60697E]">
                        <span className="font-bold">제거 좌표</span> <span className="font-normal">36.8082 / 127.009</span>
