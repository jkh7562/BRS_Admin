        ...
        <aside className="w-[340px] sticky top-0 z-50 h-screen text-white" style={{ backgroundColor: "#101213" }}>
            <div className="sidebar-content h-full overflow-y-auto p-5">
                    ...
                    {menuList.map((menu) => {
                        ...
                        return (
                            <li
                                ...
                                className={`flex items-center gap-5 cursor-pointer ${isActive ? "text-white" : "text-[#A5ACBA]"}`}
                            >
                                <img
                ...
                <div className="mt-12 pt-4 text-base space-y-2 pl-6">
                    ...
                    {/* Spring Boot */}
                    <p className="pt-6 pb-2 flex items-center gap-2 text-[#A5ACBA]">
                        <img src={springIcon || "/placeholder.svg"} alt="Spring Boot" className="w-8 h-8" />
                        Spring Boot
                        <span className={`w-2 h-2 rounded-full ${getStatusDotColor(serverStatus.appServer)} ml-2`}></span>
                    </p>

                    {/* MySQL */}
                    <p className="pt-4 pb-2 flex items-center gap-2 text-[#A5ACBA]">
                        <img src={SQLIcon || "/placeholder.svg"} alt="MySQL" className="w-8 h-8" />
                        MySQL
                        <span className={`w-2 h-2 rounded-full ${getStatusDotColor(serverStatus.database)} ml-2`}></span>
                    </p>
                    ...
                    <p className="pt-4 pb-2 flex items-center gap-2 text-[#A5ACBA]">
                        ...
                        Flask
                        <span className={`w-2 h-2 rounded-full ${getStatusDotColor(serverStatus.flaskServer)} ml-2`}></span>
                    </p>
                </div>
