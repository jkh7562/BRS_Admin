            ...
            try {
                ...
                const mappedBoxes = boxData
                    .map((entry) => {
                        ...
                        const status = box.install_status || box.installStatus
                        ...
                        console.log(`Box ${id} has ${installAlarms.length} installation alarms`)
                    ...
                    .filter((box) => {
                        return statuses.includes(box.installStatus)
                    })
